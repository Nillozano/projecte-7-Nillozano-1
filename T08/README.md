...
Cadascun de vosaltres ha d’analitzar individualment la web corporativa que ha creat per al client. Redacta una petita llista amb els punts forts i febles de la teva pròpia proposta segons el que demana el client.

### Pas 2: Debat i Contrast d’idees

Ara els membres de l’equip us reuniu per explicar les reflexions individuals de les vostres propostes. Durant aquesta fase, és obligatori que defenseu els vostres arguments posant en pràctica la comunicació assertiva i que escolteu els dels companys.

### Pas 3: Negociació i Consens Final

Després d'avaluar les diferents propostes, els integrants de l'equip heu d'entrar en una fase de negociació per triar la web definitiva. No podeu prendre la decisió de manera arbitrària; s'ha d'arribar a un acord per decidir quina solució es presentarà.
...
- Un document amb les reflexions individuals.
- Un breu informe del procés de negociació on es descrigui el consens assolit i la justificació de la tria.
