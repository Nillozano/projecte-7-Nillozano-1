...
#### Quota de Carpeta:
A la carpeta Public, apliqueu una quota de 200 MB (Hard Quota). Configureu un avís al 90% que enviï un missatge personalitzat: "Compte! FoodLogístic t'informa que estàs a punt d'esgotar l'espai compartit."

#### Filtrat de Fitxers:
A la carpeta Operacions, creeu un filtre que impedeixi guardar arxius executables (.exe, .msi) i fitxers d'àudio o vídeo.
